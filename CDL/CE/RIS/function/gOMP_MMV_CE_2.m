function [hat_x, it_num] = gOMP_MMV_CE_2(L_2, threshold, A, y, L_max)
...
for times = 1:L_max
    ...
    if norm(r0, 'fro')/r_norm > threshold ...
        || (L_2 ~= 1 && norm(r0, 'fro')/r_norm < 0.3 && times>=7) ...
        || (L_2 == 1 && norm(r0, 'fro')/r_norm < 0.8 && times>=15)
