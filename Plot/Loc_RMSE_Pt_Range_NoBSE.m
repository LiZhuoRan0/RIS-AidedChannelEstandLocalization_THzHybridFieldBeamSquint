...
r_full = RMSE.r_full;
r_full_ESPRIT = RMSE.r_full_ESPRIT;
load('.\DataFinal\Loc_RMSE_Pt\RMSE_Pt_MUSICESPRIT_Near_NoBSE.mat')
p1 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full(1:2:end) r_full],'r:o', 'LineWidth', 1.5,'MarkerSize',10);
p2 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full_ESPRIT(1:2:end) r_full_ESPRIT],'r:x', 'LineWidth', 1.5,'MarkerSize',10);
%% -    without BSE Far
...
p11 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full(1:2:end) r_full],'g:o', 'LineWidth', 1.5,'MarkerSize',10);
p22 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full_ESPRIT(1:2:end) r_full_ESPRIT],'g:x', 'LineWidth', 1.5,'MarkerSize',10);
%% -    with BSE Near
load('.\DataFinal\Loc_RMSE_Pt\RMSE_Pt_MUSICESPRIT_Near_55dBm.mat')
r_full = RMSE.r_full;
r_full_ESPRIT = RMSE.r_full_ESPRIT;
load('.\DataFinal\Loc_RMSE_Pt\RMSE_Pt_MUSICESPRIT_Near.mat')
p3 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full(1:2:end) r_full],'b:o', 'LineWidth', 1.5,'MarkerSize',10);
p4 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full_ESPRIT(1:2:end) r_full_ESPRIT],'b:x', 'LineWidth', 1.5,'MarkerSize',10);
%% -    with BSE Far
load('.\DataFinal\Loc_RMSE_Pt\RMSE_Pt_MUSICESPRIT_Far_55dBm.mat')
r_full = RMSE.r_full;
r_full_ESPRIT = RMSE.r_full_ESPRIT;
load('.\DataFinal\Loc_RMSE_Pt\RMSE_Pt_MUSICESPRIT_Far.mat')
p33 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full(1:2:end) r_full],'m:o', 'LineWidth', 1.5,'MarkerSize',10);
p44 = plot(P_t_dBm_ALL(1:2:end), [RMSE.r_full_ESPRIT(1:2:end) r_full_ESPRIT],'m:x', 'LineWidth', 1.5,'MarkerSize',10);
%% -    legend
l1 = legend([p1, p2],{  
